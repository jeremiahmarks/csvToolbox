pw={}
pw['appname']='if188'
pw['apikey']='0cc4ec07de741248e16c287285bba5b9'
import os
import csv
import xmlrpclib
...
class ISServer:
    def __init__(self):
        ...
        self.infusionsoftapp=pw['appname']
        self.baseurl = 'https://' + self.infusionsoftapp + '.infusionsoft.com/'
        self.infusionsoftAPIKey=pw['apikey']
    ...
    def getapikey(self):
        return raw_input("Please enter apikey:").strip('\n \t')
...
if __name__ == '__main__':
    a=ISServer()
    a.incrementlyGetRecords("Lead")

# if __name__ == '__main__':
#     a=ISServer()
#     for eachthing in tables.keys():
#         a.incrementlyGetRecords(eachthing)